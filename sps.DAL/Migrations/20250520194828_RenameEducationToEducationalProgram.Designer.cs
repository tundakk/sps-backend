...
namespace sps.DAL.Migrations
{
    ...
    [Migration("20250520194828_RenameEducationToEducationalProgram")]
    partial class RenameEducationToEducationalProgram
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sps.Domain.Model.Entities.EducationPeriodRate", b =>
                {
                    ...
                    b.HasIndex("PeriodId", "EducationalProgramId")
                        .IsUnique();

                    b.ToTable("EducationPeriodRates");
                });

            modelBuilder.Entity("sps.Domain.Model.Entities.EducationalProgram", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("EduCategoryId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("sps.Domain.Model.Entities.EducationPeriodRate", b =>
                {
                    b.HasOne("sps.Domain.Model.Entities.EducationalProgram", "EducationalProgram")
            ...
            modelBuilder.Entity("sps.Domain.Model.Entities.EducationalProgram", b =>
                {
                    ...
                    b.HasOne("sps.Domain.Model.Entities.EduCategory", null)
                        .WithMany("EducationalPrograms")
                        .HasForeignKey("EduCategoryId1");
