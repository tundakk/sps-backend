...
{
    /// <inheritdoc />
    public partial class RenameEducationToEducationalProgram : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EduCategoryId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationalPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EducationalPrograms_EduCategories_EduCategoryId",
                        column: x => x.EduCategoryId,
                        principalTable: "EduCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EducationalPrograms_EduCategories_EduCategoryId1",
                        column: x => x.EduCategoryId1,
                        principalTable: "EduCategories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationPeriodRates_EducationalPrograms_EducationalProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationalProgramId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_EducationalPrograms_EducationalProgramId",
                        column: x => x.EducationalProgramId,
                        principalTable: "EducationalPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportingTeachers_EducationalPrograms_EducationalProgramId",
                        column: x => x.EducationalProgramId,
                        principalTable: "EducationalPrograms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EducationalPrograms_EduCategoryId",
                table: "EducationalPrograms",
                column: "EduCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalPrograms_EduCategoryId1",
                table: "EducationalPrograms",
                column: "EduCategoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_EducationPeriodRates_EducationalProgramId",
                table: "EducationPeriodRates",
                column: "EducationalProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationPeriodRates_PeriodId_EducationalProgramId",
                table: "EducationPeriodRates",
                columns: new[] { "PeriodId", "EducationalProgramId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_EducationalProgramId",
                table: "Students",
                column: "EducationalProgramId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportingTeachers_EducationalProgramId",
